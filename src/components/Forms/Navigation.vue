...
export default {
    data() {
        return {
            ...
            iconsBox: "flex flex-row space-x-2 items-center",
            logoutBox: "flex flex-row items-center",
        }
    }
}
</script>