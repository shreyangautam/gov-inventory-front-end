...
export default {
  data() {
    return {
      logo: "w-40 h-40 my-3.5",
      mainContainer:
        "flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center",
      loginContainer:
        "flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md",
      leftContainer:
        "p-4 py-6 text-white bg-blue-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly",
      nameStyle: 
        "my-3 text-4xl font-bold tracking-wider text-center",
      descriptionStyle:
        "mt-6 font-normal text-center text-gray-300 md:mt-0",
      rightContainer:
        "p-5 bg-white md:flex-1",
      loginHeader:
        "my-4 text-2xl font-semibold text-gray-700",
      formStyle:
        "flex flex-col space-y-5 mt-14",
      inputContainer: 
